...
void ButtonNavigator::onNextPress(const Callback& callback) {
  onPress({MappedInputManager::Button::Down, MappedInputManager::Button::Right}, callback);
}

void ButtonNavigator::onPreviousPress(const Callback& callback) {
  onPress({MappedInputManager::Button::Up, MappedInputManager::Button::Left}, callback);
}

void ButtonNavigator::onNextRelease(const Callback& callback) {
  onRelease({MappedInputManager::Button::Down, MappedInputManager::Button::Right}, callback);
}

void ButtonNavigator::onPreviousRelease(const Callback& callback) {
  onRelease({MappedInputManager::Button::Up, MappedInputManager::Button::Left}, callback);
}

void ButtonNavigator::onNextContinuous(const Callback& callback) {
  onContinuous({MappedInputManager::Button::Down, MappedInputManager::Button::Right}, callback);
}

void ButtonNavigator::onPreviousContinuous(const Callback& callback) {
  onContinuous({MappedInputManager::Button::Up, MappedInputManager::Button::Left}, callback);
}
