...
- X3 release packaging now rejects truncated artwork, produces reproducible ZIPs, resolves published releases on the install page, and verifies checksums against the selected download.
